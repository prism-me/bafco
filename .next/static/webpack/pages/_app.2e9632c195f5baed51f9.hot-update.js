...
function MainMenu() {
  ...
  return __jsx("nav", {
    ...
    className: path.indexOf("/desks") > -1 ? 'active' : '',
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 415,
