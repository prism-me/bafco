...
function MainMenu() {
  ...
  return __jsx("nav", {
    ...
    src: "images/menu/hamburger-menu-image01.png",
    alt: "Banner",
    __self: this,
    __source: {
      fileName: _jsxFileName,
